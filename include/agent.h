...
public:
  Agent(std::string);
  virtual int act(uint256_t boardint, uint256_t pieceint, int pieceid, int nexpieceid) = 0;
...
class RandomAgent : public Agent
{
  public:
    RandomAgent();
    int act(uint256_t boardint, uint256_t pieceint, int pieceid, int nexpieceid) override;
};
