...
# test_search: bitboard.o board.o graph.o features.o agent.o search.o
# g++ -std=c++17 build/bitboard.o build/board.o build/graph.o build/features.o build/agent.o build/search.o test/test_search.cpp -o test/test_search
