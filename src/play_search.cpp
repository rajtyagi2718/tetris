...
void PlaySearch::run(uint256_t board_state,
...
void PlaySearch::reset(uint256_t board_state,
                       std::pair<uint256_t, int> cur_piece,
                       std::pair<uint256_t, int> nex_piece)
{
...
void PlaySearch::bfs(std::pair<uint256_t, int>& piece,
...
void PlaySearch::update_best(uint256_t& cur_terminal_state, int lines)
{
  double value = -1e6;
...
void PlaySearch::backtrack(std::vector<int>& actions)
{
...
double PlaySearch::evaluate(uint256_t board_state, int cur_line_clear)
{
